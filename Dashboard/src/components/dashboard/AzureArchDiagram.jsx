...
const layers = [
  ...
  },
  {
    ...
    color: 'accent',
    items: [
      { icon: Cloud, label: 'IoT Hub' },
      { icon: Database, label: 'Event Hub' },
      { icon: Shield, label: 'Key Vault' },
    ]
  },
  {
...
export default function AzureArchDiagram() {
  return (
    <div className="bg-card border border-border rounded-xl p-5">
      <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">Azure Cloud Architecture</h3>
